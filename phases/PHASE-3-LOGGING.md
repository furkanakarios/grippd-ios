...
- [x] **Step 2** — "İzledim/Okudum" log ekleme akışı: bottom sheet UI  
  Branch: `feature/phase-3-step-2-log-entry-flow` ✅

- [x] **Step 3** — 0-10 yarım puanlı yıldız rating UI: interactive, animasyonlu  
  Branch: `feature/phase-3-step-3-rating-ui` ✅

- [x] **Step 4** — Emoji reaksiyon sistemi: Netflix-style + serbest emoji  
  Branch: `feature/phase-3-step-4-emoji-reaction` ✅

- [x] **Step 5** — Birden fazla log desteği: aynı içerik için rewatch/reread  
  Branch: `feature/phase-3-step-5-multiple-logs` ✅

- [x] **Step 6** — Watchlist & Reading List: ekle/çıkar, sıralama  
...
- [x] **Step 10** — Yıllık özet (Wrapped): X film, Y kitap detaylı analiz  
