...
final class LocalCacheService {
    ...
    private init() {
        let schema = Schema([CachedContent.self, CachedSearchQuery.self, UserCreatedContent.self, LogEntry.self, WatchlistEntry.self, CustomList.self, CustomListItem.self])
